...
firebase_admin.initialize_app(cred, {'storageBucket': 'cucumberbot-457a1.appspot.com'})
db = firestore.client()
bucket = storage.bucket()

def generate_start_keyboard():
    keyboard = InlineKeyboardMarkup()
    keyboard.add(InlineKeyboardButton("Open Cucumber App", web_app=WebAppInfo(url="https://cucumberbotairdrop.netlify.app/")))
    return keyboard
